function Zig_out = zigzag(Quantization)
%% this is the zigzag code to read the ac parts of the quantised MBs
...
for i = 1:1:temp1
    for j = 1:1:temp2
        T = cell2mat(Quantization(i,j));
       ZZ = [T(1,2) T(2,1) T(3,1) T(2,2) ...
