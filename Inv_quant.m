function I_Quantization = Inv_quant(I_Zig_out,m,com)
...
[temp1, temp2] = size(I_Zig_out);
N = 8;
if com == 1
    for i = 1:1:temp1
       for j = 1:1:temp2
           x1 = round((cell2mat(I_Zig_out(i,j))).*Q_L);
           x2 = mat2cell(x1,N,N);
          I_Quantization(i,j) = x2;
       end    
    end
elseif com == 2 
      for i = 1:1:temp1
       for j = 1:1:temp2
           x1 = round((cell2mat(I_Zig_out(i,j))).*Q_C);
           x2 = mat2cell(x1,N,N);
          I_Quantization(i,j) = x2;
       end    
      end      
